    ...
    <div className="min-h-screen py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="absolute inset-0 bg-[url('/grid.svg')] opacity-10"></div>
          <div className="flex flex-col items-center text-center gap-8">
            <h1 className='text-4xl text-white font-bold'>Submit your abstract:</h1>
                    <p className='text-xl text-gray-300 max-w-2xl'>We invite abstracts for ideas regarding Roboweek!</p>
                    <Button
                    text="Submit Now"
                    iconLink={<i className="ri-rocket-line text-3xl"></i>}
                    href="https://forms.gle/hsAU19iuFcUtibmr9"
                    className="text-2xl bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700"
                  />
          </div>
        </motion.div>
